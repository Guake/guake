...
latex_documents = [
  ('index', 'PythonFixImports.tex', u'Python Fix Imports Documentation',
...
man_pages = [
    ('index', 'pythonfiximports', u'Python Fix Imports Documentation',
     [u'Gaetan Semet'], 1)
]
...
texinfo_documents = [
  ('index', 'PythonFixImports', u'Python Fix Imports Documentation',
   u'Gaetan Semet', 'PythonFixImports', 'One line description of project.',
   'Miscellaneous'),
]
