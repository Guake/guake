...
class Keybindings(object):
    ...
    def __init__(self, guake):
        ...
        keys = ['toggle-fullscreen', 'new-tab', 'close-tab', 'rename-current-tab',
                'previous-tab', 'next-tab', 'clipboard-copy', 'clipboard-paste',
                'quit', 'zoom-in', 'zoom-out', 'increase-height', 'decrease-height',
                'increase-transparency', 'decrease-transparency', 'toggle-transparency',
